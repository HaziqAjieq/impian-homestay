  ...
  return (
    <div className="">
      ...
      <div className=" flex  justify-center">
        ...
        <div className="grid grid-cols-6 sm:grid-cols-8 place-items-center  sm:gap-5 gap-y-[20px] mt-8 px-8 md:px-0 md:max-w-[1400px] ">
          {features.map((feature, index) => (
             <div className="features-card col-span-6 sm:col-span-4 flex flex-col items-center text-center max-w-[400px] pt-4 h-full   ">
